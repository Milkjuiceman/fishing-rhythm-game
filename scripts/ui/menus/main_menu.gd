...
@onready var background_viewport: SubViewport = $SubViewportContainer/SubViewport
...
func _ready():
	...
	# Force mouse visible after all children _ready() have run
...
func _on_options_button_pressed():
	...
	if pause_menu:
		...
		push_warning("[MainMenu] PauseMenu autoload not found!")
